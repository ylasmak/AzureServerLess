...
eh_policy_read_primary_connection_string=$(az eventhubs namespace authorization-rule  keys list \
                                          --resource-group  $resource_group_name  --namespace-name $event_Hubs_namespace \
...
az functionapp config appsettings set \
                        ...
                        --settings  "nsweatheralerteventeh_readauthorule_EVENTHUB=$eh_policy_read_primary_connection_string"
